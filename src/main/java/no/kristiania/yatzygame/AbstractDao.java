...
public abstract class AbstractDao<ENTITY> {
    ...
    public void updateGameDetail(String category,String dice, String score, Long id, String sql) throws SQLException {
        try (Connection connection = dataSource.getConnection()) {
            try (PreparedStatement preparedStatement = connection.prepareStatement(sql)) {
                preparedStatement.setString(1, category);
                preparedStatement.setString(2, dice);
    ...
    public ENTITY gamesBasedOnFNameAndLName(String id, String lName, String sql) throws SQLException {
        try (Connection connection = dataSource.getConnection()) {
            try (PreparedStatement preparedStatement = connection.prepareStatement(sql)) {
